...
// ============================
    struct Test {
        ...
        static void setTestName(std::ostream &o_stream, const std::string &i_txt, const std::string &i_funcName, const std::size_t i_lineNo, const std::size_t i_counter = std::numeric_limits<std::size_t>::max(),
                                const std::size_t i_total = std::numeric_limits<std::size_t>::max());
